...
public class NioSslServer extends NioSslPeer {
     ...
     * @throws Exception
     */
    public NioSslServer(String hostAddress, int port, SSLContext context) throws Exception {
     ...
     * As soon as the server reads these data, it will call {@link NioSslServer#write(SocketChannel, SSLEngine, byte[])}
